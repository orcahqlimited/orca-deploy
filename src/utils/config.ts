...
export const CONNECTORS: ConnectorDef[] = [
  ...
  },
  {
    ...
    description: '8 tools — CSP licence visibility, catalogue cost+RRP pricing, renewals, NCE part-month proration, plus M365 SKU lookup/compare/feature-find from Microsoft\'s licensing data (read-only). Customer supplies their own Crayon API client + service-account.',
    toolCount: 8,
